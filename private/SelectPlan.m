...
% Update DVH plot
handles.histogram = DVHViewer('axis', handles.hist_axes, ...
    'structures', handles.image.structures, ...
    'doseA', struct('data', handles.dose.data * handles.repeat, ...
    'width', handles.dose.width), 'table', handles.struct_table, ...
    'atlas', handles.atlas, 'columns', 2, 'xlabel', 'Fraction Dose (Gy)');
